...
#[test]
fn display_1in_1out() {
    assert_display(FuncType::new([ValueType::I32], [ValueType::I32]), "fn(i32) -> i32");
}

#[test]
fn display_4in_0out() {
    assert_display(
        FuncType::new([ValueType::I32, ValueType::I64, ValueType::F32, ValueType::F64], []),
        "fn(i32, i64, f32, f64)",
    );
}
