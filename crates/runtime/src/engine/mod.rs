...
use self::resumable::ResumableCallBase;
pub use self::{
...
impl Engine {
    ...
    {
        self.inner.alloc_func_body(len_locals, max_stack_height, insts, metas)
    }
...
pub struct EngineResources {
    ...
    pub func_types: FuncTypeRegistry,
}
