...
use core::cmp;
use wazm_core::{DecodeUntypedSlice, EncodeUntypedSlice, UntypedError, UntypedValue};
...
impl<'a> FuncParams<'a> {
    ...
    pub fn new(params_results: &'a mut [UntypedValue], len_params: usize, len_results: usize) -> Self {
    ...
    pub fn decode_params_into_slice(self, values: &mut [Value]) -> Result<FuncResults<'a>, UntypedError> {
