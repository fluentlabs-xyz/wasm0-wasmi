...
pub use self::{
    ...
    global::{Global, GlobalEntity, GlobalIdx, GlobalType, Mutability},
    instance::{Export, ExportsIter, Extern, ExternType, Instance, InstanceEntity, InstanceEntityBuilder, InstanceIdx},
    linker::Linker,
    memory::{DataSegmentEntity, DataSegmentIdx, Memory, MemoryEntity, MemoryIdx, MemoryType},
    module::*,
    store::{AsContext, AsContextMut, Store, StoreContext, StoreContextMut, StoreInner, Stored},
    table::{ElementSegment, ElementSegmentEntity, ElementSegmentIdx, Table, TableEntity, TableIdx, TableType},
    value::Value,
};
